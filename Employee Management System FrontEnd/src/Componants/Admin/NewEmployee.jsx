...
const AddEmployee = () => {
    const initialEmployeeState = {
        ...
        currentAddress: {
            city: 'New York',
            addressLineI: '123 Main Street',
            addressLineII: 'Apt 4B',
            pinCode: '10001'
        },
        permanentAddress: {
            city: 'Los Angeles',
            addressLineI: '456 Sunset Blvd',
            addressLineII: 'Suite 12A',
            pinCode: '90001'
        },
        emergencyContactName: 'Jane Doe',
        emergencyContactNumber: '3333543211',
        professionalDetails: {
            companyMail: 'john.doe@company.com',
            officePhone: '1234567890',
            officeAddress: {
                city: 'New York',
                addressLineI: '789 Corporate Ave',
                addressLineII: 'Floor 5',
                pinCode: '10005'
            },
            reportingManagerEmployeeCode: '10244444',
            hrName: 'Alice Johnson',
            dateOfJoining: '2020-08-01',
            employmentHistoryList: [
                {
                    employmentHistoryId: '101',
                    jobTitle: 'Junior Developer',
                    companyName: 'Tech Solutions',
                    joiningDate: '2018-07-01',
                    endingDate: '2020-07-30',
        ...
        projectDetailsList: [
            {
                ...
                reportingManagerEmployeeCode: '201'
            }
        ],
        finance: {
            panCard: 'ABCDE1234Z',
    ...
    return (
        <div className="container d-flex justify-content-center " style={{ position: 'relative', top: '90px'}}>
            <div className="row p-4">


                <form onSubmit={handleSubmit} style={{ width: '1100px' }}>
                    <h2 className=' form-control mt-3  fw-bold  text-light p-4' style={{backgroundColor:'#55c163c8'}}>New Employee Registration</h2>
                    {/* Employee Name */}
                    <div className="form-control mb-5" style={{backgroundColor:'#ebebebc8'}}>
                        ...
                        <h2 className=' form-control mt-5  fw-bold  text-light b p-4' style={{backgroundColor:'#55c163c8'}}>Professional Details</h2>
                        ...
                        {/* Finance Details */}
                        <h2 className=' form-control mt-5  fw-bold  text-light  p-4' style={{backgroundColor:'#55c163c8'}}>Finance Details</h2>
                        ...
                        <div className=" mb-5">
                            ...
                            <div className=" p-lg-4 row col-lg-12 mt-5" style={{ alignItems: 'center', display: 'flex', justifyContent: 'center' }}>
                                ...
                                <div className=" col-lg-12 text-center mt-3 " >
                                    <button type="submit" className="btn btn-info text-light fw-bold col-lg-4" style={{backgroundColor:'green'}}>Register New Employee</button>
                                </div>
                            </div>
