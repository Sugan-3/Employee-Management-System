...
export default function PutRequestMain() {
    ...
    return (
        <div className='container-fluid' style={{ position:'relative',width:'75%', marginTop:'130px'}} >
                    ...
                    <table className='table table-hover mt-3 ' style={{boxShadow :'1px 0px 20px rgba(0,0,0,0.2)'}}>
                        <thead >
                            <tr className='text-center' >
                                <th scope='col' style={{ backgroundColor: '#55c163c8', color:'white' }}>S.No</th>
                                <th scope='col' style={{ backgroundColor: '#55c163c8', color:'white' }}>Name</th>
                                <th scope='col' style={{ backgroundColor: '#55c163c8', color:'white' }}>Employee Code</th>
                                <th scope='col' style={{ backgroundColor: '#55c163c8', color:'white' }}>Mail</th>
                                <th scope='col' style={{ backgroundColor: '#55c163c8', color:'white' }}>Mobile</th>
                                <th scope='col' style={{ backgroundColor: '#55c163c8', color:'white' }}>Action</th>
                            </tr>
                        </thead>
                        <tbody style={{backgroundColor:'#ebebebc8'}}>
                        ...
                        <ul className="pagination justify-content-center" >
                            ...
                            {[...Array(totalPages)].map((_, index) => (
                                <li key={index} className={`page-item ${currentPage === index + 1 ? 'active' : ''}`}>
                                    <button className="page-link" style={{backgroundColor:'green'}} onClick={() => paginate(index + 1)}>
                                        {index + 1}
                                    </button>
                                </li>
                            ))}
