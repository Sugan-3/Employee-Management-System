    ...
    return (
        <div className="container d-flex justify-content-center " style={{marginTop:'120px'}}>
            <div className='row col-lg-11 p-4' >
                ...
                <form className='form-control p-5 mb-5' style={{backgroundColor:'#ebebebc8'}}>
                    <h2 className=' form-control  fw-bold  text-light text-center  p-3' style={{ backgroundColor: '#0dbcdb', fontSize: '20px',backgroundColor:'#55c163c8' }}>Profile</h2>
