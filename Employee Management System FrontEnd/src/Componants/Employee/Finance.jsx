...
function Finance() {
    ...
    return (
        <div className="container vh-100 align-items-center"  style={{marginTop:'120px'}} >
            <div className="row p-4">

                <h2 className=' form-control  fw-bold  text-light text-center  p-3' style={{ backgroundColor: '#55c163c8', fontSize: '20px' }}>Finance Details</h2>

                <form className="form-control  p-3" style={{backgroundColor:'#ebebebc8'}}>
