        ...
        <div className="container d-flex justify-content-center align-items-center vh-100" >
            <div className="row col-lg-12 w-100 ">
                ...
                <div className="col-lg-6 d-none d-md-flex justify-content-center  align-items-center">
                    <img src={Forgot} alt="Forgot Password" style={{ maxWidth: '80%', marginTop:'80px' }} />
                </div>

                <div className="card shadow-lg p-4 rounded-3" style={{ width: '350px', top: '8%', left: '2%', height: '400px',marginTop:'130px', backgroundColor:'#ebebebc8', marginLeft:'90px' }}>
                    ...
                    <form onSubmit={handleResetPassword} >
                        ...
                        <button type="submit" className="btn btn-primary w-100" disabled={loading} style={{backgroundColor:'green', marginTop:'30px'}}>
