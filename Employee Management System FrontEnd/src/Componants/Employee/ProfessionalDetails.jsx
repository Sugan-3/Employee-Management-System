...
function ProfessionalDetails() {
    ...
    return (
        ...
        <div className="container-fluid  d-flex justify-content-center" style={{marginTop:'120px'}} >
            <div className="row ">

                <form className='form-control p-5 mt-3 mb-5 ' style={{ width: '1000px', backgroundColor:'#ebebebc8' }}>
                    <h2 className=' form-control  fw-bold  text-light text-center p-3' style={{ fontSize: '20px',backgroundColor:'#55c163c8' }}>Professional Details</h2>
