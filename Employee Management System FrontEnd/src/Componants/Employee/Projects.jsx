...
function Projects() {
    ...
    return (
        <div className="container d-flex justify-content-center"  style={{marginTop:'110px'}} >
            <div className='row mt-3 col-lg-12 p-4'>
                <h2 className=' form-control   fw-bold  text-light  p-3' style={{ backgroundColor: '#55c163c8', width: '40%', fontSize: '18px' }}>Project Details</h2>
                <form className=' p-4 pt-4 form-control mt-3'>

                    {employee.projectDetailsList.length > 0 ? (
                        <table className="table  table-striped table-bordered table-hover" style={{ boxShadow: '1px 0px 20px rgba(0,0,0,0.1)', backgroundColor:'#ebebebc8' }}>
