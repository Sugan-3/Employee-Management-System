...
function Login() {
    ...
    return (
        <div className="container" style={{backgroundImage: `url('/src/assets/LoginPage.jpg')`, backgroundSize: 'cover',
      backgroundRepeat: 'no-repeat'}}>
            <div className="row w-100 min-vh-100">
                <div className="col-lg-6 col-md-6 mb-2 mb-sm-0">
                    <div className="img-box text-center">
                        <img src={Logo} className="img-fluid" alt="Login" style={{ maxWidth: '100%', height: '300px', marginTop:'45%' }} />
                    </div>
                </div>
